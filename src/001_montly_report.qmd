...
source('script/06_tier_2_dashboard.R', local = knitr::knit_global())
source('script/11_tier_3_summary.R', local = knitr::knit_global())
```

# **Summary - Tier 3 (All Theatres)**

```{r}
source('script/07_summary_table.R', local = knitr::knit_global())
...
source('script/02_on_time_start.R', local = knitr::knit_global())
source('script/04_early_finish_and_over_run.R', local = knitr::knit_global())
...
source('script/03_inter_operational_interval.R', local = knitr::knit_global())
...
source('script/05_utilisation_and_cases.R', local = knitr::knit_global())
